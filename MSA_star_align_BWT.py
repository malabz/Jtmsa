...
def MSA_star(S):#S  n条序列列表
    ...
    print("Loaded")
    print("center seq:", S[C])   #S[C]即为中心序列
...
if __name__ == '__main__':
    label,strs = readfasta('data/dna500.fasta')#输入文件
    Value_SP, S_aligned = MSA_star(strs)
    write(label,S_aligned,'data/dna500_align.fasta')#输出文件
